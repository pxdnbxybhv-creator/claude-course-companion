...
export const ENCOUNTERS: EncounterDef[] = [
  ...
  { id: 'taohua', zh: '桃花源', en: 'The Peach Blossom Spring', region: 'mountain', hintZh: '白日的山寺，飞瀑之后，仿佛有光。', hintEn: 'By day at the mountain temple, behind the waterfall, there seems to be light.', noteZh: '林尽水源，便得一山；山有小口，仿佛若有光。', noteEn: 'Where the grove ended at the spring there was a hill, and in it a small opening that seemed to hold light.', special: ['painter', 'poet', 'taoist'], coins: 200 },
