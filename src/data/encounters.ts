...
export const ENCOUNTERS: EncounterDef[] = [
  { id: 'zhiyin', zh: '知音', en: 'The One Who Understands', region: 'bamboo', hintZh: '竹林深处，有樵夫停斧而听。', hintEn: 'Deep in the bamboo, a woodcutter rests his axe to listen.', noteZh: '伯牙鼓琴，子期听之：巍巍乎若高山，洋洋乎若流水。', noteEn: 'Boya played; Ziqi heard mountains in it, and flowing water.', special: ['musician', 'poet', 'cat'], coins: 120 },
  ...
  { id: 'taohua', zh: '桃花源', en: 'The Peach Blossom Spring', region: 'mountain', hintZh: '飞瀑之后，仿佛有光。', hintEn: 'Behind the waterfall, there seems to be light.', noteZh: '林尽水源，便得一山；山有小口，仿佛若有光。', noteEn: 'Where the grove ended at the spring there was a hill, and in it a small opening that seemed to hold light.', special: ['painter', 'poet', 'taoist'], coins: 200 },
  ...
  { id: 'mutong', zh: '牧童遥指', en: 'The Herd-Boy Points', region: 'any', hintZh: '雨天的路上，骑牛的孩子在吹笛。', hintEn: 'On a rainy day, a child on an ox plays the flute by the road.', noteZh: '借问酒家何处有？牧童遥指杏花村。', noteEn: '"Where might I find a tavern?" The herd-boy points far off, to Apricot Blossom Village.', special: ['poet', 'fisher', 'gardener'], coins: 80 },
