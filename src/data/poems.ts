...
export const POEMS: Poem[] = [
  ...
  { lines: ['疏影横斜水清浅，暗香浮动月黄昏。'], author: '林逋', dynasty: '宋', title: '山园小梅', authorEn: 'Lin Bu',
  ...
  { lines: ['梅雪争春未肯降，骚人阁笔费评章。', '梅须逊雪三分白，雪却输梅一段香。'], author: '卢梅坡', dynasty: '宋', title: '雪梅', authorEn: 'Lu Meipo',
  ...
  { lines: ['君自故乡来，应知故乡事。', '来日绮窗前，寒梅著花未？'], author: '王维', dynasty: '唐', title: '杂诗', authorEn: 'Wang Wei',
  ...
  // ── 兰 orchid ──────────────────────────────────────────────────────────────
  { lines: ['兰叶春葳蕤，桂华秋皎洁。', '欣欣此生意，自尔为佳节。'], author: '张九龄', dynasty: '唐', title: '感遇十二首·其一', authorEn: 'Zhang Jiuling',
    en: 'Orchid leaves grow lush in spring; cassia blossoms shine clean in autumn. Such quiet thriving is its own festival.',
    plants: ['orchid'], seasons: ['spring', 'autumn'], themes: ['garden'] },
  ...
  { lines: ['手培兰蕊两三栽，日暖风和次第开。', '坐久不知香在室，推窗时有蝶飞来。'], author: '余同麓', dynasty: '明', title: '咏兰', authorEn: 'Yu Tonglu',
    en: 'I tend two or three orchids by hand; in warm sun and gentle wind they open one by one. Sitting long, I stop noticing the scent in the room — till I open the window and butterflies come in.',
    plants: ['orchid'], seasons: SPRING, themes: ['focus', 'garden'] },
  { lines: ['能白更兼黄，无人亦自芳。', '寸心原不大，容得许多香。'], author: '张羽', dynasty: '明', title: '咏兰花', authorEn: 'Zhang Yu',
  ...
  { lines: ['衙斋卧听萧萧竹，疑是民间疾苦声。'], author: '郑燮', dynasty: '清', title: '潍县署中画竹呈年伯包大丞括', authorEn: 'Zheng Xie',
    en: 'Lying in my office I hear the bamboo rustle, and wonder if it is the sound of the people\'s hardship.',
    plants: ['bamboo'], themes: ['night'] },
  ...
  { lines: ['飒飒西风满院栽，蕊寒香冷蝶难来。', '他年我若为青帝，报与桃花一处开。'], author: '黄巢', dynasty: '唐', title: '题菊花', authorEn: 'Huang Chao',
    en: 'The west wind soughs through a courtyard full of them; their hearts cold, their scent chill, few butterflies come. If one day I were Lord of Spring, I would have them bloom with the peach.',
    plants: ['chrysanthemum'], seasons: AUTUMN, themes: ['garden'] },
  ...
  { lines: ['竹喧归浣女，莲动下渔舟。', '随意春芳歇，王孙自可留。'], author: '王维', dynasty: '唐', title: '山居秋暝', authorEn: 'Wang Wei',
    en: 'Bamboo rustles — the washing girls are coming home; lotus stirs — a fishing boat slips downstream. Let spring\'s flowers fade as they will; a traveller may well stay here.',
    plants: ['bamboo', 'lotus'], seasons: AUTUMN, terms: [13], themes: ['water'] },
  ...
  { lines: ['泉声咽危石，日色冷青松。', '薄暮空潭曲，安禅制毒龙。'], author: '王维', dynasty: '唐', title: '过香积寺', authorEn: 'Wang Wei',
    en: 'A spring sobs against the steep rocks; sunlight turns cold on the green pines. At dusk by the bend of an empty pool, stillness tames the poison dragon within.',
    plants: ['pine'], themes: ['focus', 'water'] },
  ...
  // ── 荷 lotus ───────────────────────────────────────────────────────────────
  { lines: ['毕竟西湖六月中，风光不与四时同。', '接天莲叶无穷碧，映日荷花别样红。'], author: '杨万里', dynasty: '宋', title: '晓出净慈寺送林子方', authorEn: 'Yang Wanli',
  ...
  { lines: ['荷叶罗裙一色裁，芙蓉向脸两边开。', '乱入池中看不见，闻歌始觉有人来。'], author: '王昌龄', dynasty: '唐', title: '采莲曲', authorEn: 'Wang Changling',
    en: 'Lotus leaves and silk skirts cut from one green; lotus flowers open on either side of her face. Lost among the pond she cannot be seen — only a song tells you someone is coming.',
    plants: ['lotus'], seasons: SUMMER, terms: [11], themes: ['water'] },
  ...
  { lines: ['天街小雨润如酥，草色遥看近却无。', '最是一年春好处，绝胜烟柳满皇都。'], author: '韩愈', dynasty: '唐', title: '早春呈水部张十八员外', authorEn: 'Han Yu',
  ...
  { lines: ['两个黄鹂鸣翠柳，一行白鹭上青天。'], author: '杜甫', dynasty: '唐', title: '绝句', authorEn: 'Du Fu',
    en: 'Two orioles sing in the green willow; a line of white egrets climbs the blue sky.',
    seasons: SPRING, terms: [2], themes: ['morning'] },
  { lines: ['不知细叶谁裁出，二月春风似剪刀。'], author: '贺知章', dynasty: '唐', title: '咏柳', authorEn: 'He Zhizhang',
    en: 'Who cut out these fine leaves? The spring wind of the second month, like scissors.',
    seasons: SPRING, terms: [2, 3] },
  ...
  { lines: ['等闲识得东风面，万紫千红总是春。'], author: '朱熹', dynasty: '宋', title: '春日', authorEn: 'Zhu Xi',
    en: 'Easily one knows the face of the east wind: ten thousand purples, a thousand reds — all of it is spring.',
    seasons: SPRING, terms: [3], themes: ['garden'] },
  ...
  { lines: ['黑云翻墨未遮山，白雨跳珠乱入船。', '卷地风来忽吹散，望湖楼下水如天。'], author: '苏轼', dynasty: '宋', title: '六月二十七日望湖楼醉书', authorEn: 'Su Shi',
  ...
  { lines: ['月落乌啼霜满天，江枫渔火对愁眠。', '姑苏城外寒山寺，夜半钟声到客船。'], author: '张继', dynasty: '唐', title: '枫桥夜泊', authorEn: 'Zhang Ji',
    en: 'The moon sets, crows caw, frost fills the sky; river maples and fishing lights keep a sleepless traveller company. From Hanshan Temple outside Suzhou, the midnight bell reaches the boat.',
    seasons: AUTUMN, terms: [17], themes: ['night', 'moon', 'water'] },
  ...
  { lines: ['忽如一夜春风来，千树万树梨花开。'], author: '岑参', dynasty: '唐', title: '白雪歌送武判官归京', authorEn: 'Cen Shen',
    en: 'As if in one night a spring wind had come, and ten thousand pear trees burst into blossom.',
    seasons: WINTER, terms: [20], themes: ['snow', 'friendship'] },
  ...
  { lines: ['邯郸驿里逢冬至，抱膝灯前影伴身。'], author: '白居易', dynasty: '唐', title: '邯郸冬至夜思家', authorEn: 'Bai Juyi',
    en: 'At the Handan post-house the solstice finds me, hugging my knees by the lamp, my shadow for company.',
    seasons: WINTER, terms: [21], themes: ['night'] },
  ...
  { lines: ['三更灯火五更鸡，正是男儿读书时。', '黑发不知勤学早，白首方悔读书迟。'], author: '颜真卿', dynasty: '唐', title: '劝学', authorEn: 'Yan Zhenqing',
    en: 'Lamplight at midnight, the cock before dawn: the very hours for study. Black-haired, one does not know to start early; white-haired, one regrets starting late.',
    themes: ['diligence', 'night', 'morning', 'time'] },
  ...
  { lines: ['古人学问无遗力，少壮工夫老始成。', '纸上得来终觉浅，绝知此事要躬行。'], author: '陆游', dynasty: '宋', title: '冬夜读书示子聿', authorEn: 'Lu You',
  ...
  { lines: ['业精于勤，荒于嬉；行成于思，毁于随。'], author: '韩愈', dynasty: '唐', title: '进学解', authorEn: 'Han Yu',
    ...
    themes: ['diligence'] },
  { lines: ['千淘万漉虽辛苦，吹尽狂沙始到金。'], author: '刘禹锡', dynasty: '唐', title: '浪淘沙', authorEn: 'Liu Yuxi',
    en: 'Sifted a thousand times, strained ten thousand — hard work indeed; but blow away all the wild sand and you reach the gold.',
    themes: ['diligence', 'water'] },
  { lines: ['山重水复疑无路，柳暗花明又一村。'], author: '陆游', dynasty: '宋', title: '游山西村', authorEn: 'Lu You',
    en: 'Hill after hill, stream after stream — I doubt there is a way; then dark willows, bright flowers, and another village.',
    seasons: SPRING, themes: ['diligence'] },
  ...
  { lines: ['茅檐长扫净无苔，花木成畦手自栽。', '一水护田将绿绕，两山排闼送青来。'], author: '王安石', dynasty: '宋', title: '书湖阴先生壁', authorEn: 'Wang Anshi',
  ...
  { lines: ['花间一壶酒，独酌无相亲。', '举杯邀明月，对影成三人。'], author: '李白', dynasty: '唐', title: '月下独酌', authorEn: 'Li Bai',
  ...
  { lines: ['床前明月光，疑是地上霜。', '举头望明月，低头思故乡。'], author: '李白', dynasty: '唐', title: '静夜思', authorEn: 'Li Bai',
    en: 'Bright moonlight before my bed — I took it for frost on the ground. I lift my head to gaze at the bright moon, lower it, and think of home.',
    seasons: AUTUMN, themes: ['moon', 'night'] },
  { lines: ['星垂平野阔，月涌大江流。'], author: '杜甫', dynasty: '唐', title: '旅夜书怀', authorEn: 'Du Fu',
    en: 'Stars hang low over the wide plain; the moon surges on the great river\'s flow.',
    themes: ['night', 'moon', 'water'] },
  ...
  { lines: ['海内存知己，天涯若比邻。'], author: '王勃', dynasty: '唐', title: '送杜少府之任蜀州', authorEn: 'Wang Bo',
    ...
    themes: ['friendship'] },
  { lines: ['渭城朝雨浥轻尘，客舍青青柳色新。', '劝君更尽一杯酒，西出阳关无故人。'], author: '王维', dynasty: '唐', title: '送元二使安西', authorEn: 'Wang Wei',
    en: 'Morning rain in Weicheng settles the light dust; by the inn the willows are fresh and green. Have one more cup of wine, my friend — west of Yang Pass there will be no old friends.',
    seasons: SPRING, themes: ['friendship', 'rain', 'morning'] },
  { lines: ['桃花潭水深千尺，不及汪伦送我情。'], author: '李白', dynasty: '唐', title: '赠汪伦', authorEn: 'Li Bai',
    en: 'Peach Blossom Pool is a thousand feet deep, yet not as deep as Wang Lun\'s kindness in seeing me off.',
    seasons: SPRING, themes: ['friendship', 'water'] },
  ...
  { lines: ['年年岁岁花相似，岁岁年年人不同。'], author: '刘希夷', dynasty: '唐', title: '代悲白头翁', authorEn: 'Liu Xiyi',
    en: 'Year after year the flowers look the same; year after year the people are not.',
    seasons: SPRING, themes: ['time', 'garden'] },
  ...
  { lines: ['水光潋滟晴方好，山色空蒙雨亦奇。'], author: '苏轼', dynasty: '宋', title: '饮湖上初晴后雨', authorEn: 'Su Shi',
    en: 'Rippling light on the water is lovely in sun; hills veiled in mist are wonderful in rain as well.',
    seasons: SPRING, themes: ['rain', 'water'] },
];
