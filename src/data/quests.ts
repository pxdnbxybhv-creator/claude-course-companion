...
export const QUESTS: QuestDef[] = [
  ...
  { id: 'q-all', zh: '群贤毕至', en: 'All Friends Gathered', descZh: '集齐十二位同伴。', descEn: 'Gather twelve companions.', hintZh: '完成同伴之约，并收下初见礼。', hintEn: 'Finish every companion quest, and accept the First Gift in your letters.', goal: { kind: 'companions', target: 12 }, reward: { character: 'change' } },
  // Seals for the album
  ...
  // 玉兔 used to come with this one; she now arrives in the 初见礼 letter, and the feast earns 团圆
  { id: 'q-mooncake', zh: '八月十五', en: 'Mid-Autumn Feast', descZh: '吃掉中秋的八块月饼。', descEn: 'Eat all eight Mid-Autumn mooncakes.', hintZh: '中秋那几天，或在「节日」里预览中秋。', hintEn: 'Around Mid-Autumn — or preview it from the Festivals panel.', goal: { kind: 'counter', key: 'mooncake', target: 8 }, reward: { seal: '团圆', sealEn: 'Reunion' } },
